-- Fix authentication context and improve get_maintenance_history function
...
BEGIN
    ...
    -- Check if user is super admin by email (more reliable for our system)
    is_super_admin_user := (
    ...
    IF NOT is_super_admin_user THEN
        ...
        -- If still no company found and user is authenticated, return empty result
