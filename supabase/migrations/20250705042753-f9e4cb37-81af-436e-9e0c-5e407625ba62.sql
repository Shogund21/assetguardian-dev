...
DECLARE
    ...
    demo_company_name text := 'Demo Facilities Inc.';
BEGIN
    -- Check if demo company already exists
    SELECT id INTO demo_company_id 
    FROM public.companies 
    WHERE name = demo_company_name AND is_trial = true;
    ...
    IF demo_company_id IS NULL THEN
        INSERT INTO public.companies (
            ...
            demo_company_name,
            true,
            now() + INTERVAL '365 days', -- Long expiration for demo
            now(),
            'demo@example.com',
        ...
        PERFORM public.generate_demo_data(demo_company_id, demo_company_name);
        
        RAISE NOTICE 'Created demo company with ID: %', demo_company_id;
    ELSE
